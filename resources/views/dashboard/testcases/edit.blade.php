...
@section('container')
    ...
    <div class="col-lg-8">
        {{-- karena methodnya post ke url/dashboard/testcases , dia akan mengarahkan ke class store --}}
        <form method="post" action="/dashboard/testcases/{{ $testcase->id }}" class="mb-5">
          ...
          <div class="mb-3">
            ...
            <select class="form-select" required name="surah" id="surah_input">
              ...
              @foreach ($surahs as $surah)
                @if (old('surah', $testcase->surah) == $surah["nomor"])
                <option selected value="{{ $surah["nomor"] }}">{{ $surah["nomor"] }}. {{ $surah["nama_latin"] }}</option>
                @else
          ...
          @enderror
            ...
            <div class="mb-3">
                ...
                <select class="form-select ayat" required id="ayat_input" name="ayat_surah">
                  <option selected value="{{ $testcase["ayat_surah"] }}">{{ $testcase["ayat_surah"] }}</option>
                </select>
              </div>
              @error('ayat_surah')
                <div class="invalid-feedback">
    ...
    <script>
        $(document).ready(function(){
            ...
            var jumlah_ayat = getAyat(getSurah);
            var old_ayat = $('#ayat_input').val();
